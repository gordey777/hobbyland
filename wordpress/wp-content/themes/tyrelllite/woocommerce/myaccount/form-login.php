...
<?php endif; ?>
	...
	<div>
		...
		<h2><?php _e( 'Registered customers', 'tyrell' ); ?></h2>
...
<?php if (get_option('woocommerce_enable_myaccount_registration')=='yes') : ?>
	...
	<div class="span4 woo-register-form"> 
		<h2><?php _e("Not registered?", "tyrell"); ?></h2>
		<p><?php _e("Creating an account  is quick and easy, and will allow you to move through our checkout quicker.", "tyrell"); ?></p>

		<div class="register-button-wrapper">
			<button class="btn open-register-form"><?php _e("Register", "tyrell"); ?></button>
		</div>
	</div>
		...
		<div class="register-popup">
			...
			<form method="post" class="register">
				...
				<?php endif; ?>
					...
					<label for="reg_email"><?php _e( 'Email', 'tyrell' ); ?> <span class="required">*</span></label>
