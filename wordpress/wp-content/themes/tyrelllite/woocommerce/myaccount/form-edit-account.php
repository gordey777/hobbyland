...
<div class="row">
	...
	<div class="span9" id="customer_details">
		...
		<h3 class="myaccount-heading"><?php _e("Change Account", "tyrell"); ?></h3>
		...
		<form action="" method="post">
			...
			<p><button class="btn btn-sm btn-style-1" type="submit" name="save_account_details" /><?php _e( 'Save changes', 'woocommerce' ); ?></button></p>
