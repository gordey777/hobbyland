...
<div class="images">
	...
	<div id="singleProductGallery" class="carousel slide">
	  ...
	  <div class="carousel-inner">
	    <div class="active item"><a title="<?php echo $image_title; ?>" data-rel="prettyPhoto[product-gallery]" href="<?php echo $image_link; ?>"><?php echo $image; ?></a></div>
...
<div class="product-share clearfix">
	<span><?php _e("Share", "tyrell"); ?></span>
	<ul>
	    <li><a href='mailto:?subject=<?php the_title(); ?>&amp;body=<?php echo nl2br(strip_tags(get_the_title())).nl2br(strip_tags(': ')).'%0A%0A'.nl2br(strip_tags(get_permalink())).'%0A%0A'.nl2br(strip_tags(get_the_excerpt())); ?>' class="product-share-email"></a></li>
