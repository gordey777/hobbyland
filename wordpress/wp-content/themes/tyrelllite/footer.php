    ...
    <?php if ( ! is_404() && ! is_search() && $page_data['portfolio_page'] == get_the_ID()): ?>
        <?php wp_enqueue_script( "isotope_theme_files", get_template_directory_uri()  . "/assets/js/isotope_theme_files.js" ); ?>
    <?php endif; ?>
    <?php wp_enqueue_script( "functions", get_template_directory_uri()  . "/assets/js/functions.js", '', '', true ); ?>
    <?php wp_enqueue_script( "lightbox", get_template_directory_uri()  . "/assets/js/lightbox.js", '', '', true ); ?>
    <?php wp_enqueue_script( "easing2", get_template_directory_uri()  . "/assets/js/easing.js", '', '', true ); ?>
    <?php wp_enqueue_script( "cookie", get_template_directory_uri()  . "/assets/js/jquery.cookie.js", '', '', true ); ?>
    <?php wp_enqueue_script( "active_scripts", get_template_directory_uri()  . "/assets/js/active_scripts.js", '', '', true ); ?>
    ...
    <?php if(!isset($_COOKIE["tyrell-notification-closed"]) || $shop_data["notification_changes"] != $_COOKIE["tyrell-notification-closed"]): ?>
