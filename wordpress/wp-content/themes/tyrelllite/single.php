		...
		<?php
				...
				<?php if( isset($meta) && isset($meta["portfolio_side_content"]) && $meta["portfolio_side_content"][0] != "" ): ?>
					<div class="span5 side-content-wrapper">
						<div class="post-title">
		                    <h1><?php _e("Project details", "tyrell"); ?></h1>
		                </div>
			...
			<?php if( get_the_terms($post->ID, 'portfolio_category') ): ?>
				...
				<div class="portfolio-single-recent">
					<h3><?php _e("Related projects", "tyrell"); ?></h3>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class("clearfix "); ?>>
	                <?php $check_if_text_only = true; ?>
	                    ...
	                    <header class="clearfix">
	                        ...
	                        <div class="post-date">
	                            <span><?php echo get_the_date('j F Y'); ?></span> &nbsp;/&nbsp; <a href="<?php echo the_permalink(); ?>#comments"><?php echo $post->comment_count; ?> <?php echo __('comments', 'tyrell'); ?></a>
	                        </div>
	                    </header>
