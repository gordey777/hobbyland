    ...
    <div class="row-fluid page">
                    ...
                    <header>
                        ...
                        <div class="post-date-comments2">
                            ...
                            <a href="<?php echo the_permalink(); ?>#comments">
                                <?php echo $post->comment_count; ?> <?php echo __('comments', 'tyrell'); ?>
                            </a>
        ...
        <?php else : ?>
            ...
            <div id="post-0" class="post no-results not-found">
                <h2 class="post-title"><?php _e( 'Nothing Found', 'tyrell' ); ?></h2>
                <div class="post-text sidebar">
                    <p><?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'tyrell' ); ?></p>
