...
<ul class="cart_list product_list_widget <?php echo $args['list_class']; ?>">
	...
	<?php if ( sizeof( $woocommerce->cart->get_cart() ) > 0 ) : ?>
		...
		<li class="empty"><?php printf( _n( '%d item in the cart', '%d items in the cart', $woocommerce->cart->cart_contents_count, 'tyrell' ), $woocommerce->cart->cart_contents_count ); ?></li>
		...
		<?php foreach ( $woocommerce->cart->get_cart() as $cart_item_key => $cart_item ) :
			...
			<li>
				...
				<span class="clearfix">
					<?php echo __("Price", "tyrell") . ": " . $product_price; ?>
				</span>
