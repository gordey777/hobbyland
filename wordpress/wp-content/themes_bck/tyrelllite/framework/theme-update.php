...
define( 'NOTIFIER_THEME_NAME', 'Tyrell Lite' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'tyrelllite' ); // The theme folder name
define( 'NOTIFIER_THEME_LATEST_VERSION', '1-1-3' ); // Latest version of the theme
define( 'NOTIFIER_XML_FILE', 'http://cdn.dessky.com/notifiers/tyrelllite.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
function update_notifier_menu() {  
	if (function_exists('simplexml_load_string')) { // Stop if simplexml_load_string funtion isn't available
		...
		if( (string)$xml->latest > (string)$theme_data['Version']) { // Compare current theme version with the remote XML version
...
function update_notifier() { 
	...
	<div class="wrap">
		...
		<img style="float: left; margin: 0 20px 20px 0; border: 1px solid #ddd;" src="<?php echo get_bloginfo( 'template_url' ) . '/screenshot.jpg'; ?>" />
